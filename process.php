...
$avatar = filter_var($_POST['avatar'], FILTER_SANITIZE_STRING);
 // Insert new student
 $sql = "INSERT INTO users (firstname, lastname, email, phonenumber, address1, address2, city, state, postalcode, gender, avatar)
...
if (mysqli_query($conn, $sql)) {
  ...
  $last_id = mysqli_insert_id($conn);
    foreach($_POST["courseid"] as $courseid) {
        echo '<p>' .$courseid.'</p>';
        $sql ="INSERT INTO myclasses (studentid, courseid) VALUES ('{$last_id}','{$courseid}')";
    ...
    echo "Error: " . $sql . "<br>" . mysqli_error($conn);
        ...
        <div class="row">
        <div class="col-lg-12"><h2>Your Course List</h2>
        ';
  		foreach($_POST["courseid"] as $courseid) {
...
?>
<a href="index.php">return to link</a>
<?
echo '</div>
        <div>
        <div>';
