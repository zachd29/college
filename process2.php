...
<div class="container" style="background-color:white;opacity:.75;padding-top:250px;padding-bottom:250px;">
         <div class="row">
         <div class="col-lg-2">
         </div>
         <div class= "text-center col-lg-8"><h1>Thank You For Registering!</h1> <h3 style="color:black;"> Check email for a list of courses</h3>


             <div class="text-center" >
            <a href="index.php" style="font-size:20px;color:blue;">Back to form</a>
         </div>
         </div>
         <div class="col-lg-2">
         </div>
